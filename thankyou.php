            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-wrapper">
                        <a href="#" class="logo" ><img src="./img/horisontal-logo.svg" alt="Logo: Best Tour Plan"></a>
                ...
                <div class="container">
                    <nav class="navbar-menu">
                        <ul class="navbar-menu__list">
                            <li class="navbar-menu__item nav-bar-menu__item--mobile_visible">
        ...
        <footer class="footer">
            <div class="container">
                <div class="footer__wrapper">
                    <a class="footer__logo footer-logo" href="#"><img class="footer-logo__img" src="./img/vertical-logo.svg" alt="image:VerticalLogo"></a>
